    ...
    <>
      ...
      <div className='h-screen bg-valorant-white flex flex-col justify-center gap-5 sm:hidden'>
        <div>
          ...
          <div className='text-8xl font-Mohave font-bold tracking-tighter leading-[72px] uppercase text-valorant-black mx-9'>valorant</div>
        </div>
        ...
        <p className='text-[19.20px] text-valorant-grey tracking-wider leading-tight mx-9'>
          Blend your style and experience on a global, competitive stage. You have 13 rounds to attack and defend your side using sharp gunplay and
          tactical abilities. And, with one life per-round, you'll need to think faster than your opponent if you want to survive. Take on foes across
          Competitive and Unranked modes as well as Deathmatch and Spike Rush
        </p>
        <div className='flex justify-center mt-10'>
          <button className='h-[60px] w-[300px] bg-valorant-red rounded text-valorant-white font-bold uppercase'>learn the game</button>
        </div>
      </div>
      ...
      <div className='h-screen bg-valorant-red flex flex-col justify-center gap-5 relative overflow-hidden sm:hidden'>
        <div className='my-10'>
          ...
          <div className='text-8xl font-Mohave font-bold tracking-tighter leading-[72px] uppercase text-valorant-white mx-5'>agents</div>
        </div>

        <div className='text-[23.04px] mx-5 tracking-wide uppercase font-bold text-valorant-white z-10'>
          creativity <span className='font-Playfair lowercase italic font-thin text-xl -mx-1'>is</span> your greatest weapon
        </div>

        <p className='text-[19.20px] text-valorant-white tracking-wider leading-tight mx-5 mb-20 z-10'>
          More than guns and bullets, you'll choose an Agent armed with adaptive, swift, and lethal abilities that create opportunities to let your
          gunplay shine. No two Agents play alike, just as no two highlights reels will look the same.
        </p>

        <div className='flex justify-center mt-10 z-10'>
          <a href='/agents'>
            <button className='h-[60px] w-[300px] bg-valorant-white rounded text-valorant-black font-bold uppercase'>view all agents</button>
          </a>
        </div>
      ...
      <div className='h-screen flex flex-col justify-around gap-5 relative overflow-hidden bg-off-black sm:hidden'>
        ...
        <div className='flex justify-center mt-16 z-10'>
          <button className='h-[75px] w-[350px] bg-valorant-red rounded text-valorant-white font-bold uppercase'>download game client</button>
        </div>

        {/* riot logo */}
        <div className='flex justify-around items-center text-valorant-red mx-16 -mb-5 z-10'>
          <div className='w-[110px]'>
            <svg version='1.1' baseProfile='full' xmlns='http://www.w3.org/2000/svg' fill='#D13639' viewBox='0 0 110 35'>
              <path
        ...
        <p className='text-[10px] text-center text-off-white px-6 leading-tight mb-5 z-10'>
          © 2020-2024 Riot Games, Inc. RIOT GAMES, VALORANT and any associated logos are trademarks, service marks, and/or registered trademarks of
          Riot Games, Inc.
        </p>
        ...
        <div className='w-full flex '>
          ...
          <div className='ml-24 2xl:ml-32 flex flex-col gap-5'>
            ...
            <div className='w-[675px] text-[19.20px] font-sans tracking-wider leading-[24px] text-valorant-grey'>
              Blend your style and experience on a global, competitive stage. You have 13 rounds to attack and defend your side using sharp gunplay
              and tactical abilities. And, with one life per-round, you'll need to think faster than your opponent if you want to survive. Take on
              foes across Competitive and Unranked modes as well as Deathmatch and Spike Rush.
            </div>
            <button className='h-[60px] w-[300px] bg-valorant-red rounded text-valorant-white font-bold uppercase'>learn the game</button>
          </div>
      ...
      <div className='hidden sm:flex flex-col justify-end items-start h-screen bg-valorant-red text-valorant-white relative'>
        {/* top sub title */}
        <div className='font-Mohave font-bold uppercase text-8xl absolute 2xl:top-28 top-10 left-8 2xl:left-12 tracking-tighter'>
          creativity <span className='font-Playfair italic font-normal tracking-tight lowercase text-[64px] relative bottom-3'>is</span> your greatest
          weapon.
        </div>
        ...
        <div className='w-full flex mb-20'>
          ...
          <div className='flex flex-col'>
            <div>
              ...
              <div className='font-Mohave font-bold uppercase text-[300px] tracking-tighter leading-[18rem] mr-12'>agents</div>
            </div>

            <p className='font-sans text-[19.20px] w-[425px] tracking-wider leading-6 ml-16 mb-5'>
              More than guns and bullets, you'll choose an Agent armed with adaptive, swift, and lethal abilities that create opportunities to let
              your gunplay shine. No two Agents play alike, just as no two highlight reels will look the same.
            </p>
      ...
      <div className='hidden sm:flex flex-col justify-start items-center h-screen bg-off-black text-valorant-white relative overflow-hidden'>
        ...
        <div className='mt-32 z-10'>
          ...
          <div className='w-full flex justify-center mb-10 2xl:hidden'>
            <svg width='1340' height='192.57' viewBox='0 0 349 50' fill='none' xmlns='http://www.w3.org/2000/svg'>
              ...
              <defs>
                <clipPath id='clip0_50_366'>
                  <rect width='348.837' height='50' fill='#FF4655' />
                </clipPath>
              </defs>
            </svg>
          </div>
        ...
        {/* logos */}
        <div className='flex justify-around items-end text-valorant-red w-72 mb-3 z-20'>
          {/* riot logo */}
          <div className='w-[110px]'>
            <svg version='1.1' baseProfile='full' xmlns='http://www.w3.org/2000/svg' fill='#D13639' viewBox='0 0 110 35'>
              <path
        ...
        <p className='font-sans font-light text-[10px] w-[479px] text-center mb-5 z-20'>
          © 2020-2024 Riot Games, Inc. RIOT GAMES, VALORANT and any associated logos are trademarks, service marks, and/or registered trademarks of
          Riot Games, Inc.
        </p>
