    ...
    <>
      ...
      <div className='flex flex-col justify-end items-center h-screen'>
        ...
        <div className='mb-[125px] flex flex-col items-center'>
          ...
          <p className='font-sans text-neutral-200 uppercase text-xs text-center w-[232px] my-3'>A 5v5 character-based tactical shooter</p>
        </div>
      </div>
      ...
      {/* agents */}
      <div className='h-screen bg-valorant-red flex flex-col justify-center gap-5 relative overflow-hidden'>
        <div className='my-10'>
      ...
      {/* footer */}
      <div className='h-screen flex flex-col justify-around gap-5 relative overflow-hidden'>
        ...
        {/* riot logo */}
        <div className='flex justify-around items-center text-valorant-red mx-10 z-10'>
        ...
        <img
          className='absolute border -bottom-10 scale-[4] opacity-75'
