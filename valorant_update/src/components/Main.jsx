      ...
      <div className="hidden flex-col justify-center items-start h-screen sm:flex bg-valorant-white text-valorant-black">
        ...
        <div className="w-full flex ">
          ...
          <div className="ml-24 2xl:ml-32 flex flex-col gap-5">
            ...
            <button className="h-[60px] w-[300px] bg-valorant-red rounded text-valorant-white font-bold uppercase hover:bg-valorant-black">
              learn the game
            </button>
          </div>
      ...
      <div className="hidden sm:flex flex-col justify-end items-start h-screen bg-valorant-red text-valorant-white relative">
        ...
        <div className="w-full flex mb-20">
          ...
          <div className="flex flex-col">
            ...
            <a href="/agents">
              <button className="h-[60px] w-[300px] bg-valorant-white rounded text-valorant-black font-bold uppercase mt-5 ml-36 hover:bg-valorant-black hover:text-valorant-white">
                view all agents
              </button>
            </a>
          </div>
          ...
          <div className="w-1/2 flex justify-center items-center">
            <div className="w-[70%] h-[55%] flex flex-col 2xl:ml-20">
              ...
              <ul className="font-sans text-[19.2px] text-valorant-red -mt-2 z-40">
                <li>
                  <a className="hover:border-b-2 hover:border-b-valorant-white" href="/">
                    about
                  </a>
                </li>
                <li>
                  <a className="hover:border-b-2 hover:border-b-valorant-white" href="/agents">
                    agents
                  </a>
                </li>
                <li>
                  <a className="hover:border-b-2 hover:border-b-valorant-white" href="/weapons">
                    weapons
                  </a>
                </li>
                <li>
                  <a className="hover:border-b-2 hover:border-b-valorant-white" href="/maps">
                    maps
                  </a>
                </li>
              </ul>
          ...
          <div className="w-1/2 flex justify-center items-center">
            <div className="w-[60%] h-[50%] flex flex-col items-end 2xl:mr-20">
              ...
              <div className="font-sans text-[19.2px] text-valorant-red mr-5 -mt-2 z-40">
                <a className="hover:text-valorant-white" href="/">
                  download game client
                </a>
              </div>
            </div>
