...
const Main = () => {
  return (
    ...
    <>
      ...
      {/* footer */}
      <div className="h-screen flex flex-col justify-around gap-5 relative overflow-hidden bg-off-black">
        {/* <img src={require('../images/mobile-valorant-title-red.svg')} alt="logo" /> */}
        {/* valorant title */}
        <div className="flex justify-center mt-28 h-96">
        ...
        <img
          className="absolute border -bottom-8 scale-[3.8] opacity-75"
