  ...
  return (
    <>
      ...
      <div className='h-screen bg-valorant-white sm:hidden flex flex-col justify-center gap-4 relative'>
        <div className='font-Mohave font-bold uppercase tracking-tighter text-valorant-red text-8xl ml-5 mt-20'>agents</div>
        ...
        <div className='font-Mohave font-bold uppercase tracking-tighter text-valorant-black text-5xl relative ml-5 whitespace-pre-wrap'>
          check <span className='font-Playfair italic font-normal lowercase text-valorant-red text-[40px] absolute bottom-3 -mx-1'>the</span>
          {'     '}
          headcount
        </div>

        <p className='font-sans text-valorant-grey leading-tight tracking-wide text-[19.20px] w-[325px] ml-5'>
          Find more ways to plant the Spike on your enemies with scrappers, strategists, and hunters of every description.
        </p>
      ...
      <div className='hidden h-screen bg-valorant-white sm:flex flex-col justify-center items-center relative'>
        <div className='absolute 2xl:top-[250px] top-[240px] font-Mohave font-bold uppercase tracking-tighter text-valorant-red text-[300px] leading-3 z-10'>
          agents
        </div>

        <div className='font-Mohave font-bold uppercase tracking-tighter text-valorant-black text-8xl relative ml-5 whitespace-pre-wrap 2xl:mb-[105px] mb-[16px] z-10'>
          check <span className='font-Playfair italic font-normal lowercase text-valorant-red text-[64px] absolute bottom-8 -mx-1'>the</span>
          {'    '}
          headcount
        </div>

        {/* agent select */}
        <div className='absolute 2xl:h-[450px] h-[350px] w-[1350px] bg-valorant-black flex justify-around items-center bottom-5 z-10'>
          <p className='font-sans text-valorant-grey leading-tight tracking-wide text-[19.20px] w-[600px] text-center absolute 2xl:top-3 top-1'>
            Find more ways to plant the Spike on your enemies with scrappers, strategists, and hunters of every description.
          </p>

          <div className='text-off-white flex justify-around 2xl:h-[70%] h-[80%] w-full'>
            {/* Duelist Agents */}
        ...
        <div className='absolute w-full h-screen overflow-hidden'>
          <img
            className='absolute scale-[.6] 2xl:scale-50 z-0 right-[500px] -bottom-72 2xl:-bottom-96'
            src='https://media.valorant-api.com/agents/f94c3b30-42be-e959-889c-5aa313dba261/fullportrait.png'
            alt='raze'
          />
          <img
            className='absolute scale-[.6] 2xl:scale-50 z-0 left-[500px] -bottom-72 2xl:-bottom-96'
            src='https://media.valorant-api.com/agents/1e58de9c-4950-5125-93e9-a0aee9f98746/fullportrait.png'
            alt='killjoy'
          />
        </div>
