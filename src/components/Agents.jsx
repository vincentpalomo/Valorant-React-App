...
const HeroUpdate = () => {
  ...
  return (
    <div className="mt-10 sm:m-0">
      <div className="grid grid-cols-1 gap-2 sm:gap-0 sm:m-0">
        {agents.map((agent) => {
          return (
            <div key={agent.uuid}>
              {agent.isPlayableCharacter && (
                <div className="flex flex-col items-center gap-2 sm:gap-0 sm:flex-row">
                  <div className="flex flex-col items-center sm:justify-center sm:gap-5 gap-1 sm:h-[60rem] sm:bg-base-200 sm:w-4/5">
                  ...
                  <div className="relative h-[24rem] sm:h-full overflow-hidden">
                    <img
                      className="absolute scale-[2.5] sm:scale-[2.5] left-32 top-52 sm:top-72 sm:left-48 z-10"
