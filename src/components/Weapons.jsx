          ...
          return (
            <div className=' md:grid md:grid-cols-1 lg:flex lg:flex-row lg:h-[50rem]' key={weapon.uuid}>
              <div className='relative flex flex-col justify-center items-center lg:w-3/4 lg:bg-base-200 border-2'>
                ...
                {weapon.shopData !== null && (
                  <div className='w-3/4 z-20'>
                    ...
                    <p className='font-Mohave uppercase text-center lg:text-3xl '>rounds/sec: {weapon.weaponStats.fireRate}</p>
                    <p className='font-Mohave uppercase text-center lg:text-3xl '>reload speed: {weapon.weaponStats.reloadTimeSeconds}</p>
                    <p className='font-Mohave uppercase text-center lg:text-3xl '>magazine size: {weapon.weaponStats.magazineSize}</p>
              ...
              <div className='lg:relative flex flex-col justify-center items-center sm:h-full lg:w-1/3'>
                <img className='lg:absolute lg:right-10 lg:z-10 lg:scale-105' src={weapon.displayIcon} alt={weapon.displayName} />
              </div>
            </div>
          );
        })}
