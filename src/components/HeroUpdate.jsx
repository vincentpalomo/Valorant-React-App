            ...
            <div key={agent.uuid}>
              {agent.isPlayableCharacter && (
                <div className="flex flex-col items-center gap-2 sm:flex-row">
                  <div className="flex flex-col items-center sm:justify-center sm:gap-5 gap-1 sm:h-[50rem] sm:bg-base-100 sm:rounded-r-3xl sm:w-4/5">
                    <h1 className="text-8xl sm:text-[20rem] sm:tracking-[-.045em] text-slate-100 font-Mohave font-bold tracking-tight uppercase">
                      {agent.displayName}
                    </h1>
                          ...
                          <div key={i}>
                            <div className="flex flex-col justify-center items-center">
                              <img
                                ...
                                className="h-10 w-10 sm:h-32 sm:w-32"
                              />
                              <p className="sm:uppercase sm:font-Mohave sm:font-black sm:text-xl">
                                {ability.displayName}
                              </p>
                            </div>
                          </div>
                  ...
                  <div className="relative overflow-hidden">
                    <img
                      className="absolute scale-150 sm:scale-[2.5] left-20 top-20 sm:top-72 sm:left-48 z-10"
